<form action="{{ action('Admin\Bot\BotCatController@postAlert') }}" method="post" >
    <div class="modal fade" id="dialog_alert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
