															...
															<div class="col-md-3 col-sm-3 no-padding">
																<div class="submenu-lists">
																	...
																	<div class="nav nav-tabs" role="tablist">
                                                                        ...
                                                                        <div class="list" role="presentation"><a href="{{ action('IndexController@getAppeal') }}" aria-controls="hair-style" role="tab" data-toggle="tab">Проверить жалобу</a></div>
																	</div><!-- End Nav Tab -->
										...
										<div class="row">
											<form >
												...
												<div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" class="button btn btn-default">Проверить</button>
                                                    </div>
												</div><!-- End Column 6 -->
